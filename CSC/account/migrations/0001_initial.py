# Generated by Django 2.2.9 on 2020-01-19 05:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('semester', models.CharField(blank=True, choices=[('1', 'Primero'), ('2', 'Segundo'), ('3', 'Tercero'), ('4', 'Cuarto'), ('5', 'Quinto'), ('6', 'Sexto'), ('7', 'Séptimo'), ('8', 'Octavo'), ('9', 'Noveno'), ('10', 'Décimo'), ('11', 'Onceavo'), ('12', 'Doceavo')], default='', max_length=1, verbose_name='semestre')),
                ('birthday', models.DateField(blank=True, verbose_name='fecha de nacimiento')),
